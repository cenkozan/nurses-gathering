...
var ClientsComponent = (function () {
    function ClientsComponent(clientService, formBuilder, http, toast) {
        ...
        this.systolic = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]('');
        this.diastolic = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]('');
        this.dateOfTakingBloodPressure = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"]('');
        this.genders = [];
        this.genders.push({ label: 'Male', value: 'M' });
        this.genders.push({ label: 'Female', value: 'F' });
        this.genders.push({ label: 'Other', value: 'O' });
    ...
    ClientsComponent.prototype.cancelEditing = function () {
        this.isEditing = false;
        this.client = new __WEBPACK_IMPORTED_MODULE_5__data_model__["d" /* Client */]();
    ...
    ClientsComponent.prototype.addBloodPressure = function (client) {
        var bloodPressure = new __WEBPACK_IMPORTED_MODULE_5__data_model__["c" /* BloodPressure */]();
    ...
    ClientsComponent.prototype.addClientWeight = function (client) {
        var weight = new __WEBPACK_IMPORTED_MODULE_5__data_model__["f" /* Weight */]();
    ...
    ClientsComponent.prototype.addClientTemperature = function (client) {
        var temperature = new __WEBPACK_IMPORTED_MODULE_5__data_model__["e" /* Temperature */]();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return Temperature; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return Weight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return BloodPressure; });
...
var ReportsComponent = (function () {
    ...
    ReportsComponent.prototype.generateBloodPressureReport = function () {
        var systolicData = [];
        var diastolicData = [];
        this.selectedClient.bloodPressures.forEach(function (b) {
            var x = __WEBPACK_IMPORTED_MODULE_5_moment__(b.date);
